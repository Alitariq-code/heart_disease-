...
knn_model = load(r'C:\Users\miana\Desktop\django_heart_1\heart_project\heart\second\knn_model.joblib')
base_path = 'C:/Users/miana/Desktop/django_heart_1/heart_project/heart/second'
...
model_cnn_path = os.path.join(base_path, 'cnn1.h5')
model_lstm_path = os.path.join(base_path, 'cnn2.h5')
model_gru_path = os.path.join(base_path, 'cnn3.h5')
...
def load_models_and_votes(input_features):
    # Load sklearn models
